...
export default function Maintenance() {
  ...
  return (
    <div className="ml-50">
      <div className="flex-1 p-8 space-y-8 font-sans" style={{ fontFamily: "'Inter', sans-serif" }}>
                ...
                allraiserequest.map((req) => (
                  <tr key={req._id} className="hover:bg-gray-50 align-middle">
                    ...
                    <td className="px-4 py-3 border">
                      <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${req.aiPriority === "high"
                    ...
                    <td className="px-4 py-3 border">
                      <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${req.status === "pending"
                          ? "bg-yellow-100 text-yellow-800"
                    ...
                    <td className="px-4 py-3 border max-w-[400px]">
                      <p className="line-clamp-3">{req.description || "N/A"}</p>
                    </td>
                ...
                allraiserequest
                  ...
                  .map((req) => (
                    <tr key={req._id} className="hover:bg-gray-50 align-middle">
                      ...
                      <td className="px-4 py-3 border">
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${req.status === "in-process"
                            ? "bg-purple-100 text-purple-800"
                            : "bg-gray-100 text-gray-800"
                          }`}>
                          {req.status}
